...
namespace Elvis
{
template <class C, class K, class V> class ICache
{
public:
    ICache() = default;
...
template <class K, class V> class TimeCache : public ICache<TimeCache<K, V>, K, V>
{
public:
    TimeCache(int capacity)
        : m_Capacity(capacity){};
...
template <class K, class V> class LRUCache : public ICache<TimeCache<K, V>, K, V>
{
public:
...
public:
    ...
    template <class ICache> ICache* GetCache();
};

template <class CACHE> class CacheManager : public ICacheManager
{
public:
...
template <class ICache> ICache* ICacheManager::GetCache()
{
