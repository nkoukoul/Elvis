...
{
public:
    HttpResponseCreator(std::shared_ptr<OutputContext> tcpOutputContext, std::shared_ptr<ICryptoManager> cryptoManager);
...
{
public:
    WebsocketResponseCreator(std::shared_ptr<OutputContext> tcpOutputContext);
...
{
public:
    HttpResponseContext(std::shared_ptr<OutputContext> tcpOutputContext, std::shared_ptr<ICryptoManager> cryptoManager)
    {
        this->m_ResponseCreator =
            std::make_shared<HttpResponseCreator>(tcpOutputContext, cryptoManager); // default for now
    }
};
...
{
public:
    WebsocketResponseContext(std::shared_ptr<OutputContext> tcpOutputContext)
    {
        this->m_ResponseCreator = std::make_shared<WebsocketResponseCreator>(tcpOutputContext); // default for now
    }
};
} // namespace Elvis
