...
int main(int argc, char* argv[])
{
    ...
    std::shared_ptr<Elvis::RouteManager> routeManager = std::make_shared<Elvis::RouteManager>();
    ...
    routeManager->SetRoute("/triggers", "POST", std::move(std::make_unique<TriggerPostController>()));
    routeManager->SetRoute("/login", "POST", std::move(std::make_unique<UserPostController>()));
